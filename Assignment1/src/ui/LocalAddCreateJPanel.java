 ...
 * @author lydia
 */
public class LocalAddCreateJPanel extends javax.swing.JPanel {

    /**
     * Creates new form localAddCreateJPanel
     */
    
    LocalAddHistory localAddHistory;
    public LocalAddCreateJPanel(LocalAddHistory localAddHistory) {
        initComponents();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        LocalAdd la = localAddHistory.addNewLocalAdd();
        
        la.setCity(city);
        la.setName(name);
        la.setState(state);
        la.setStreetAdd(streetAdd);
